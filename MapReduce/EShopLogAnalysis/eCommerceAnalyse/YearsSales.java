 ...
 * 统计每年的销量，销售额，
 * 看下单的时间年份
 * 数据为2004年1月1日--2018年3月14日
 * @author leowxm
 *
 */

public class YearsSales {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Job job;
			job=Job.getInstance(conf, "YearsSales");
			job.setJarByClass(YearsSales.class);
			...
			Path outputPath = new Path("/Test/YearsSales");
