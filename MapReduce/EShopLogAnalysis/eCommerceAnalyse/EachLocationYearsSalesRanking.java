...
/**
 * 
 * 对每个地区（共10个）十五年来的消费情况进行排名（消费金额>>消费次数）。
...
public class EachLocationYearsSalesRanking {
	...
	public static void main(String[] args) {
		try {
			...
			Job job;
			job=Job.getInstance(conf, "EachLocationYearsSalesRanking");
			job.setJarByClass(EachLocationYearsSalesRanking.class);
			...
			FileInputFormat.addInputPath(job, new Path("/Test/EachLocationYearsSales/Loction9/part-r-00000"));
			Path outputPath = new Path("/Test/EachLocationYearsSalesRanking/Location9");
