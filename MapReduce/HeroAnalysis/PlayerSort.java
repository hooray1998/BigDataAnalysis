...
public class PlayerSort {
	public static class PlayerSortMapper extends Mapper<Text, Text, Text, NullWritable>{
	...
	public static class PlayerSortReducer extends Reducer<Text, NullWritable, Text, NullWritable>{
		int num = 0;
		@Override
	...
	public static class RankSort extends WritableComparator{
		...
		public int compare(WritableComparable a, WritableComparable b) {
			...
			Integer aname = Integer.parseInt(awords[0]);//number
			Integer bname = Integer.parseInt(bwords[0]);
...
//			System.out.println(br);
	...
	public static void main(String[] args) {
		try {
			...
			Job job;
			job=Job.getInstance(conf, "PlayerSort");
			job.setJarByClass(PlayerSort.class);

			job.setMapperClass(PlayerSortMapper.class);
			job.setReducerClass(PlayerSortReducer.class);
			...
			//多文件输入
			Path inputPath1 = new Path("/HERO/PlayerInfo");
			FileInputFormat.addInputPath(job,inputPath1);			
			
			Path outputPath = new Path("/HERO/PlayerTop10");
